    ...
    <section className="jobSec">
      <div className="content">
        ...
        <div className="comTtlBox">
          <h2 className="headLine04 fadeInUp"><span className="en">Job List</span><span className="jp">採用情報</span></h2>
          {jobExplanation !== "コメントアウト" && (
            <p className="title fadeInUp" dangerouslySetInnerHTML={{ __html: jobExplanation }} />
          )}
        </div>
        ...
        <div className="infoSec">
          ...
          {jobs.length > 0 ? (
            jobs.map((jobContext, index) => {
              ...
              const pageSlug = jobContext.slug;
              return (
            ...
            <p className="fadeInUp">現在、募集中の職種はありません。</p>
          )
          }
        </div>
