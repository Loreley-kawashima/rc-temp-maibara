...
import emailIcon from "/src/images/icon/mail.png"
...
const Component = () => {
  ...
  // 職種詳細ページのみを判定し、isRecruitPageに代入している。
  const isRecruitPage = /^\/recruit\/[^/]+\/?$/.test(location.pathname);
        ...
        <div className="rBox clearfix">
          <div className="btn">
            {isRecruitPage ?
              ...
              :
              <Link to="https://yoneharahoken.com/" target="_blank">
                公式サイト
              </Link>
            }
          </div>
